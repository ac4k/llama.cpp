...
static __global__ void k_set_rows(
    ...
    dst_row_ptr[i00] = ggml_ac4k_cast<dst_t>(src0_row[i00]);
...
static void set_rows_cuda(ggml_backend_ac4k_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, ggml_tensor * dst) {
...
void ggml_ac4k_op_set_rows(ggml_backend_ac4k_context & ctx, ggml_tensor * dst) {
