...
void ggml_ac4k_mul_mat_f(ggml_backend_ac4k_context & ctx, const ggml_tensor * src0, const ggml_tensor * src1, const ggml_tensor * ids, ggml_tensor * dst) {
    ...
    ggml_ac4k_pool_alloc<int32_t> ids_src_compact_dev;
    ggml_ac4k_pool_alloc<int32_t> ids_dst_compact_dev;
    ggml_ac4k_pool_alloc<int32_t> expert_bounds_dev;
    ...
    if (ids && ncols_dst > 16) {
        ...
        ggml_ac4k_launch_mm_ids_helper(ids_d, ids_src_compact_dev.get(), ids_dst_compact_dev.get(), expert_bounds_dev.get(),
...
bool ggml_ac4k_should_use_mmf(enum ggml_type type, int cc, int warp_size, const int64_t * src0_ne, const int src1_ncols, bool mul_mat_id) {
