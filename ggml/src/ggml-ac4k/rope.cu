...
template <bool forward>
void ggml_ac4k_op_rope_impl(ggml_backend_ac4k_context & ctx, ggml_tensor * dst) {
...
void ggml_ac4k_op_rope(ggml_backend_ac4k_context & ctx, ggml_tensor * dst) {
    ggml_ac4k_op_rope_impl<true>(ctx, dst);
}

void ggml_ac4k_op_rope_back(ggml_backend_ac4k_context & ctx, ggml_tensor * dst) {
    ggml_ac4k_op_rope_impl<false>(ctx, dst);
}
